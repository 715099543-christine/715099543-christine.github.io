...
(function (root, factory) {
  ...
  function domInit() {
    ...
    if (account) account.addEventListener("click", function () { var h = $("hero-account"); if (h) h.scrollIntoView({ behavior: "smooth", block: "start" }); });
    var profileEntry = $("chat-profile");
    if (profileEntry) profileEntry.addEventListener("click", function () { var p = $("profiles"); if (p) p.scrollIntoView({ behavior: "smooth", block: "start" }); });
    var vbEntry = $("chat-voice-builder");
    if (vbEntry) vbEntry.addEventListener("click", function () { var vb = $("voice-builder"); if (vb) { vb.classList.remove("hidden"); vb.scrollIntoView({ behavior: "smooth", block: "start" }); } });
