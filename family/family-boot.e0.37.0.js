...
(function () {
  ...
  function startConsole() {
    if (unlocked) return;
    unlocked = true;
    var scripts = ["../verity-digest.e0.37.0.js", "../zh.e0.37.0.js", "../family-insurance.e0.37.0.js", "../voice-nlu.e0.37.0.js", "voice-builder.e0.37.0.js"];
    var index = 0;
    (function next() {
  ...
  function registerShell() {
    ...
    navigator.serviceWorker.register("./sw.js?v=e0.37.0").catch(function () {
      /* 离线外壳注册失败不影响在线使用 */
    });
  }
